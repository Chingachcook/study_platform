...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Функция</div>
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/problems/' . $problem->id . '/edit') }}" title="Редактировать Функцию"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        {!! Form::open([
                            'method' => 'DELETE',
